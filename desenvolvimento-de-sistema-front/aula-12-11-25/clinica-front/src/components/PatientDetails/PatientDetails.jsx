      ...
      <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
        ...
        {isEditingExam ? (
          ...
          exams.map((exam) => (
            <div
              key={exam.id}
              className="border rounded-xl p-4 mb-4 bg-gray-50hover:bg-gray-100 transition">
              ...
              <div className="flex gap-3 mt-3">
                <button
                  ...
                  className="bg-blue-500 hover:bg-blue-600text-white px-3 py-1 rounded-md text-sm">
                  Editar
                </button>
                <button
